                  ...
                  <ul className="nk-menu nk-menu-main ui-s2">
                    <li className="nk-menu-item has-sub">
                      ...
                      <ul className="nk-menu-sub">
                        ...
                        <li className="nk-menu-item">
                          <a href="index-sales.html" className="nk-menu-link">
                            <span className="nk-menu-text">
                              Sales Dashboard
                            </span>
                          </a>
                        ...
                        <li className="nk-menu-item">
                          <a href="index-crypto.html" className="nk-menu-link">
                            <span className="nk-menu-text">
                              Crypto Dashboard
                            </span>
                          </a>
                      ...
                      <ul className="nk-menu-sub">
                        ...
                        <li className="nk-menu-item has-sub">
                          ...
                          <ul className="nk-menu-sub">
                            <li className="nk-menu-item">
                              <a
                                href="pages/errors/404-      classNameic.html"
                                target="_blank"
                                className="nk-menu-link"
                              >
                                <span className="nk-menu-text">
                            ...
                            <li className="nk-menu-item">
                              <a
                                href="pages/errors/504-      classNameic.html"
                                target="_blank"
                                className="nk-menu-link"
                              >
                                <span className="nk-menu-text">
                          ...
                          <ul className="nk-menu-sub">
                            ...
                            <li className="nk-menu-item">
                              <a
                                ...
                                className="nk-menu-link nk-menu-toggle"
                              >
                                <span className="nk-menu-text">Wizard</span>
                              </a>
                              <ul className="nk-menu-sub">
                                <li className="nk-menu-item">
                                  <a
                                ...
                                <li className="nk-menu-item">
                                  <a
                                    ...
                                    className="nk-menu-link"
                                  >
                                    <span className="nk-menu-text">Survey</span>
                                  </a>
                                </li>
                                <li className="nk-menu-item">
                                  <a
                          ...
                          <ul className="nk-menu-sub">
                            ...
                            <li className="nk-menu-item">
                              <a
                                ...
                                className="nk-menu-link"
                              >
                                <span className="nk-menu-text">Ratings</span>
                        ...
                        <div className="card card-bordered card-full">
                          ...
                          <div className="nk-tb-list">
                            ...
                            <div className="nk-tb-item">
                              ...
                              <div className="nk-tb-col tb-col-sm">
                                <div className="user-card">
                                  <div className="user-avatar user-avatar-xs bg-azure-dim">
                                    <span>VA</span>
                                  </div>
                              ...
                              <div className="nk-tb-col tb-col-lg">
                                <span className="tb-sub">18/10/2019</span>
                              </div>
                              <div className="nk-tb-col">
                                <span className="tb-sub tb-amount">
                                  1.094780 <span>BTC</span>
                                </span>
                              </div>
                              <div className="nk-tb-col tb-col-sm">
                                <span className="tb-sub text-success">
                                  Completed
                                </span>
                              </div>
                            ...
                            <div className="nk-tb-item">
                              ...
                              <div className="nk-tb-col tb-col-sm">
                                <div className="user-card">
                                  <div className="user-avatar user-avatar-xs bg-purple-dim">
                                    <span>EH</span>
                                  </div>
                                  <div className="user-name">
                                    <span className="tb-lead">Emma Henry</span>
                                  </div>
                                </div>
                              </div>
                              <div className="nk-tb-col tb-col-lg">
                            ...
                            <div className="nk-tb-item">
                              ...
                              <div className="nk-tb-col tb-col-sm">
                                <div className="user-card">
                                  <div className="user-avatar user-avatar-xs bg-teal-dim">
                                    <span>AF</span>
                                  </div>
                                  <div className="user-name">
                                    <span className="tb-lead">Alice Ford</span>
                                  </div>
                                </div>
                              </div>
                              <div className="nk-tb-col tb-col-lg">
        ...
        <div className="nk-opt-panel" data-simplebar>
          ...
          <div className="nk-opt-set">
            ...
            <div className="nk-opt-list col-2x">
              ...
              >
                <span className="nk-opt-item-bg">
                  <span className="nk-opt-item-name">Clean</span>
                </span>
              </div>
              <div
                className="nk-opt-item only-text"
              ...
              >
                <span className="nk-opt-item-bg">
                  <span className="nk-opt-item-name">Shady</span>
                </span>
              </div>
              <div
                className="nk-opt-item only-text"
            ...
            <div className="nk-opt-list col-4x">
              ...
              >
                <span className="nk-opt-item-bg is-light">
                  <span className="bg-lighter"></span>
                </span>
          ...
          <div className="nk-opt-set nk-opt-set-skin">
            ...
            <div className="nk-opt-list">
              ...
              >
                <span className="nk-opt-item-bg">
                  <span className="skin-default"></span>
                </span>
                <span className="nk-opt-item-name">Default</span>
              </div>
              <div className="nk-opt-item" data-key="skin" data-update="blue">
                <span className="nk-opt-item-bg">
                  <span className="skin-blue"></span>
                </span>
      ...
      <div className="pmo-lv pmo-dark">
        ...
        >
          <div className="pmo-text text-white">
            ...
            out <em className="ni ni-arrow-long-right"></em>
          </div>
        </a>
      </div>
    </div>
